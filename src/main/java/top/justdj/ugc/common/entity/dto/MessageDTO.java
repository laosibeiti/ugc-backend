...
public class MessageDTO {
	...
	public static top.justdj.ugc.common.entity.dto.MessageDTO linkSuccess(String toUser){
		top.justdj.ugc.common.entity.dto.MessageDTO message = new top.justdj.ugc.common.entity.dto.MessageDTO();
	...
	public static top.justdj.ugc.common.entity.dto.MessageDTO linkError(String toUser){
		top.justdj.ugc.common.entity.dto.MessageDTO message = new top.justdj.ugc.common.entity.dto.MessageDTO();
		message.setFrom("system");
		message.setTo(toUser);
		message.setMessageType(1);
