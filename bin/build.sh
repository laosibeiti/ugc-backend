...
2)sudo docker tag $var1  registry-vpc.cn-shanghai.aliyuncs.com/justdj/ugc_backend_online:1.0.7
  sudo docker push  registry-vpc.cn-shanghai.aliyuncs.com/justdj/ugc_backend_online:1.0.7
  echo "online 服务滚动升级"
   docker service update \
   --image registry.cn-shanghai.aliyuncs.com/justdj/ugc_backend_online:1.0.7 \
